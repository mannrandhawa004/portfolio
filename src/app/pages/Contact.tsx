...
const Contact = () => {
    ...
    return (
        <>
            <section
                id="contact"
                className="relative min-h-screen  flex flex-col lg:flex-row items-center justify-cener text-white px-6 lg:px-16 py-20 gap-12 lg:gap-20 overflow-hidden"
            >
                <div
                    className={cn(
                        "absolute inset-0",
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                peer"
                                    required
                                />
                                {/* <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500/0 via-blue-500/20 to-purple-500/0 -z-10 blur opacity-0 peer-focus:opacity-100 transition-all duration-500"></div> */}
                            </div>
                        </div>
                                ...
                                {isSubmitting ? (
                                    ...
                                    <>
                                        ...
                                        <svg className="h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 10l-2 2m0 0l-2-2m2 2v2.5M20 7V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h15a2 2 0 002-2v-2" />
                                        </svg>
                                    </>
                                )}
                            </span>
                            <div className="absolute inset-0 bg-white text-black opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur"></div>
                        </motion.button>
                    </form>
                        ...
                        {submitStatus === "success" && (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-zinc-300 font-medium">Message sent successfully! I'll get back to you soon.</p>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
                ...
                {/* Right: Image with drop shadow and hover float */}
                <motion.div
